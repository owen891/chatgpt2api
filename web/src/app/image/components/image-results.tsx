                      ...
                      if (image.status === "cancelled") {
                        return (
                          <div key={image.id} className="break-inside-avoid">
                            <div
                              className={cn(
                                "overflow-hidden rounded-xl border border-stone-200 bg-stone-100/70",
                            ...
                            >
                              <div className="flex h-full min-h-16 flex-col items-center justify-center gap-2 px-2 py-3 text-center text-stone-500 sm:gap-3 sm:px-6 sm:py-8">
                                ...
                                <p className="text-[10px] leading-4 text-stone-400 sm:text-xs">已停止</p>
                                <button
                                  type="button"
                                  onClick={() => void onRetryImage(selectedConversation.id, turn.id, image.id)}
                                  className="rounded-full bg-white px-2 py-1 text-[10px] font-medium text-stone-600 shadow-sm transition hover:bg-stone-200 sm:px-3 sm:text-xs"
                                >
                                  重新生成这一张
                                </button>
                              </div>
                      ...
                      return (
                        <div key={image.id} className="break-inside-avoid">
                          ...
                          <div className="flex h-full flex-col items-center justify-center gap-1.5 px-2 py-3 text-center text-stone-500 sm:gap-3 sm:px-6 sm:py-8">
                            ...
                            <button
                              type="button"
                              onClick={() => void onCancelImage(selectedConversation.id, turn.id, image.id)}
                              className="inline-flex items-center gap-1 rounded-full bg-white px-2 py-1 text-[10px] font-medium text-stone-600 shadow-sm transition hover:bg-stone-200 sm:px-3 sm:text-xs"
                            >
                  ...
                  <div className="mt-3 flex items-center gap-1.5 text-[11px] sm:mt-4">
                    {turn.images.some((image) => image.status === "loading") ? (
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-full bg-stone-900 px-2.5 py-1 font-medium text-white transition hover:bg-stone-700"
                      >
                        <Square className="size-2.5 fill-current" />
                        停止剩余生成
                      </button>
